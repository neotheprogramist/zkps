...
contract modular_verifier_verifier is IModularVerifier{
    ...
    bytes32 constant vk1 = bytes32(0x6a6452a134328104e256431f7556931794dce7bef3520f562c0d6cd105ca2796);
    bytes32 constant vk2 = bytes32(0x76ec3ac70d2d9058bd45cc7f41825d828a1cf664ac4c2abe2b171ba71eb98033);
    ...
    uint64  constant table_end_offset = table_offset + 6336;
    uint64  constant quotient_offset = 6400;
...
//        tr_state.current_challenge = commitment_scheme.initialize(tr_state.current_challenge);
        tr_state.current_challenge = modular_commitment_scheme_verifier.initialize(tr_state.current_challenge);
    ...
    function verify(
        ...
        if(public_input.length > 0) {
            if (!public_input_direct(blob[3041:3041+6400], public_input, state)) {
...

        {
            ...
            uint256[3] memory permutation_argument = modular_permutation_argument_verifier.verify(
                blob[0xa1:3041+6400],
...
//            ICommitmentScheme commitment_scheme = ICommitmentScheme(_commitment_contract_address);
            ...
            if(!modular_commitment_scheme_verifier.verify_eval(
